...
app.get('/', async (req, res) => {
  try {
    ...
    const modifiedHtml = html.replace('<!-- USERS -->', generateTableRows(admins));
    ...
    rows += `
      <tr>
       <td><b>${user.type}</b></td>
          <td><b>${user.id}</b></td>
          <td><b>${user.name}</b></td>
          <td><a href="${user.whatsappLink}"><img src="images/ws.png" width="25"></a></td>
          <td><a href="${user.messengerLink}"><img src="https://i.ibb.co/QKPB6CQ/pngwing-com-31.png" width="25"></a></td>
